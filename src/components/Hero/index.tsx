        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4">
              <div
                className="hero-content wow fadeInUp mx-auto max-w-[780px] text-center flex items-center flex-col"
                data-wow-delay=".2s"
              >
                <h1 className="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]">
                  A collection of production-ready React hooks
                </h1>
                ...
                <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-auto my-4 w-80">
                  <code className="block">
                    npm i @supunlakmal/hooks
                  </code>
                </pre>
                ...
                <ul className="mb-10 flex flex-wrap items-center justify-center gap-5">
                  ...
                  <li>
                    <Link
                      href="https://github.com/supunlakmal/hooks"
                      target="_blank"
                ...
                {/* <div>
                  <p className="mb-4 text-center text-base font-medium text-white/60">
                    Hooks is now available for all Racat js , Next js
                  </p>
                  <div
